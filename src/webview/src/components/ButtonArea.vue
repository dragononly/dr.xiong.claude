  ...
  <div class="button-area-container">
    <div class="button-row">
      ...
      <div class="actions-section">
        ...
        <!-- Export Summary Button (导出总结) -->
        <button
          class="action-button"
          :class="{ 'exporting': isExporting }"
          :disabled="isExporting || messageCount < 1"
          @click="handleExportSummary"
          :aria-label="isExporting ? 'Exporting...' : 'Export summary'"
          :title="isExporting ? 'Exporting...' : 'Export conversation summary to markdown'"
        >
          <span
            class="codicon text-[16px]!"
            :class="isExporting ? 'codicon-loading codicon-modifier-spin' : 'codicon-wand'"
          />
        </button>
