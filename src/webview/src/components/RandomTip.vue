...
const tips = computed(() => {
  ...
  return [
    '从哪里开始？可以先了解一下这个代码库，或者直接开始写代码。',
    "准备好写代码了吗？\n让我们写出值得部署的代码吧。",
    '输入 /model 来选择合适的模型。',
    '创建 CLAUDE.md 文件，Claude 每次都会读取其中的指令。',
    "厌倦了重复说明？使用 CLAUDE.md 让 Claude 记住你的偏好设置。",
    '按 Shift + Tab 可以自动批准代码编辑。',
    `选中文本后按 ${platformKey} + K 可以针对选中内容进行对话。`,
